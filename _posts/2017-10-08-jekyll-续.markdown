...
将源代码复制并粘贴到名为default.html的文件中。 
将default.html文件放在_layouts文件夹中。","Put the default.html file inside the _layouts folder.",null,null,3],["这将是您的页面和帖子的默认布局模板，即当Jekyll构建网站时，每个页面或帖子将使用此布局。
