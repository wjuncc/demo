...
这2种写法都会创建React元素，来描述React应该在一致性过程中render内容，如果您想知道更多有关React元素与组件，参阅[Dan Abramov的这篇文章](https://reactjs.org/blog/2015/12/18/react-components-elements-and-instances.html)，参阅官方文档了解[一致性处理](https://reactjs.org/docs/reconciliation.html)。
