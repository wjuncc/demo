...
中文在这里！ [https://zhuanlan.zhihu.com/p/24776678](https://zhuanlan.zhihu.com/p/24776678)   
非常感谢译者！
...
当用HOC包装组件时，你会失去原来的WrappedComponents名字，这在开发和调试的时候会影响到你。

通常是通过采用WrappedComponents名称和预先考虑的东西来自定义HOC名称。
以下内容来自React-Redux。
