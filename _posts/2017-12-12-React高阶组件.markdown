...
他们都创建了React元素来描述React应该在对账过程中呈现的内容，如果您想了解更多有关React元素与组件的信息，参阅[Dan Abramov的这篇文章](https://reactjs.org/blog/2015/12/18/react-components-elements-and-instances.html)，参阅官方文档了解[一致性处理](https://reactjs.org/docs/reconciliation.html)。
