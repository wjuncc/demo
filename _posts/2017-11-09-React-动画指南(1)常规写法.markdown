---
layout: post
title:  "React 动画指南(1)常规写法"
date:   2017-11-09 03:47:21 +0800
categories:  
tags: 
    - react
    - 笔记
...
《使用ReactTransitionGroup做动画》，X    
《ReactTransitionGroup指南》，X 太长。       
《React动画指南》。V  

**给我一个理由**：  

* 因为在react项目踩到地雷了，地雷就是“动画一直是react的弱项”。读资料，把坑填平。
* 考虑到一定是用TweenMax，没有第2选择，google-> TweenMax React，找到[gsap官网论坛](https://greensock.com/forums/topic/13970-wrote-an-article-that-demos-how-to-use-gsap-with-react/)，顺藤摸瓜[Medium](https://medium.com/appifycanada/animations-with-reacttransitiongroup-4972ad7da286)，有340个赞，讨论12个，不是冷门。
* google了一圈没找到中文翻译，为了吃透，做翻译   
* [在github搜索 TweenMax componentWillEnter findDOMNode](https://github.com/search?q=TweenMax+componentWillEnter+findDOMNode&type=Code&utf8=%E2%9C%93) ,能发现很多线索。  
 
* [不乏味的react做的blog](http://www.benjanes.com/)[git](https://github.com/benjanes/benjanes.github.io/tree/fbc3de355a69ae98e51b3d94c13f58bb11aa95a1)
* [一个快速建站的用到了缓动](https://github.com/acomito/personal-site)[Meteor ](https://themeteorchef.com/base/introduction)
* [React-动画](http://pinggod.com/2016/React-动画/)

	cd E:\n\learn\react\ReactUI\v0
	npm install
	npm start
	
	 C:\Users\Administrator\AppData\Roaming\npm-cache\_logs\2017-12-21T23_20_20_842Z-debug.log
...
喜欢调试JS 干货(quick and dirty skill)??，给我发tweet@CheapSteak :）
