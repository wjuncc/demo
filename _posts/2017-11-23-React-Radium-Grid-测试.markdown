...
This one is neither suitable in mini-site nor correct in back-end interface in producing enviroment, for the mini-site's css exports from the psd , and then modifty to css-module in react.On the other hand, ui suite like Meteor and react-ui is a better choose for back-end ui, without the incompatible problem caused by various ui-components. 
