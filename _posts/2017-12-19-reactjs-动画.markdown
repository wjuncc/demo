...
猜测是你的“d”字符串没有匹配的数值。   
如果是这样的话，您需要使用MorphSVGPlugin（Club GreenSock的会员权益 - 即使点数变化很大，它也允许您在任何“d”数据之间变形）。 [http://greensock.com/club/](http://greensock.com/club/)



我相信React可以运行GSAP.给我更多信息。
...
5月4日发布  
超简单的：  
只需打开pen设置（pen settings），并在JavaScript区域，有一个“快速添加”下拉列表中有GreenSock TweenMax。
或者您可以从我们的下载覆盖中复制CDN网址
...
举报帖子
5月5日发布
由于我不是一个React人，所以我无法为findDOMNodes提供很多帮助，而你的示例codepen完全没有功能（看起来像你刚刚粘贴到JS面板的ES6代码，并留下一切空白） 
