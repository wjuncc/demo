...
**关于标题**：  
原名 [Animations with ReactTransitionGroup – Appify – Medium medium.com](https://medium.com/appifycanada/animations-with-reacttransitiongroup-4972ad7da286),   
意即《使用ReactTransitionGroup做动画》，   
改成《ReactTransitionGroup指南》，不过ReactTransitionGroup什么鬼？长长像坨屎，不好吃啊。     
最后改成《React动画指南》。  
