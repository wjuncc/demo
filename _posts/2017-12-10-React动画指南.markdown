...
* 考虑到一定是用TweenMax，没有第2选择，在gsap官网论坛发现了[这个](https://greensock.com/forums/topic/13970-wrote-an-article-that-demos-how-to-use-gsap-with-react/),扫了一眼，感觉不错，讨论挺多的，绝不是冷门。
