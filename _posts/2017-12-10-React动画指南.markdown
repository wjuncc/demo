...
* 考虑到一定是用TweenMax，没有第2选择，google了一下TweenMax React，在gsap官网论坛找到了[Wrote an article that demos how to use GSAP with React](https://greensock.com/forums/topic/13970-wrote-an-article-that-demos-how-to-use-gsap-with-react/),扫了一眼，感觉不错，讨论挺多的，绝不是冷门。
...
**开张大吉请吃鸡。**
### 使用ReactTransitionGroup来制作React动画 ###
**笔记：**  
这个教程简单2个步骤：
...
### 第二步，添加ReactTransitionGroup，实现正方形切换时淡入淡出的动画 ###
**笔记：**  
操作：
