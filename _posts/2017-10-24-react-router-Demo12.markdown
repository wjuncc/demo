...
source code from [git](https://github.com/reactjs/react-router-tutorial/tree/master/lessons/12-navigating)
...
powershell
```powershell
cd E:\n\learn\react\router\lessons\12-navigating
npm install
