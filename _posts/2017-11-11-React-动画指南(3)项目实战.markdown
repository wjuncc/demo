...
uninstall
	...
	npm uninstall --save-dev gsap
	npm uninstall --save-dev signals
	npm uninstall --save-dev react-transition-group

	
	npm uninstall --save-dev gsap signals react-transition-group
